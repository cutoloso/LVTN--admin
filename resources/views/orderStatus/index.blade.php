        ...
        <div class="card-body">
            <div class="table-responsive">
                ...
                <table class="table table-hover table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                    @foreach ($order_status as $ord_sta)
                        <tr>
                            <td>{{ $ord_sta->name }}</td>
                            <td>{{ $ord_sta->description }}</td>
                            <td>{{ $ord_sta->updated_at }}</td>
                            <td class="text-center">
                                <button class="btn btn-secondary js-btn-edit" data-id="{{$ord_sta->id}}" data-token="{{ csrf_token() }}"><i class="fas fa-edit"></i></button>
                            </td>
                            <td class="text-center">
                                <button class="btn btn-danger js-btn-del" data-id="{{$ord_sta->id}}" data-token="{{ csrf_token() }}"><i class="fas fa-minus"></i></button>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
